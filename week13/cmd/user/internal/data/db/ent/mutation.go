...
import (
	"context"
	"eshop/cmd/user/internal/data/db/ent/address"
	"eshop/cmd/user/internal/data/db/ent/card"
	"eshop/cmd/user/internal/data/db/ent/predicate"
	"eshop/cmd/user/internal/data/db/ent/user"
	"fmt"
	"sync"
	"time"
